defmodule FileProcessor do
  ...
  def longest_line! do
    ...
    |> File.stream!()               # Stream the file line by line
    |> Enum.reduce("", fn line, longest -> #not sure if there is easier than this lol. how cool we can pass the whole function to a variable
    ...
    IO.puts("#{longest_line}") # this will display as is when there is "" in the file and not "\
  end
